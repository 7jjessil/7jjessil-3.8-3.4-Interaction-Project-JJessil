...
try {
	$conn = new PDO('mysql:host=localhost;dbname=JJessil_13dit_Safari_Trips_Advisory', '_JJessil', 'UTexBXIdTb68Iwan');
	...
	die("Error Connecting to Database: JJessil_13dit_Safari_Trips_Advisory");
}
?>