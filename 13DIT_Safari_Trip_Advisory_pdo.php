...
try {
	$conn = new PDO('mysql:host=localhost;dbname=JJessil_13DIT_Safari_Trip_Advisory', '_JJessil', 'UTexBXIdTb68Iwan');
	...
	die("Error Connecting to Database: JJessil_13DIT_Safari_Trip_Advisory");
}
?>